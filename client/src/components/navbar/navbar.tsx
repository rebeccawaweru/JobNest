    ...
    return (
        ...
        <Container fluid className="px-5">
          ...
          <Nav activeKey="/" className="mx-auto gap-4 fw-normal lh-lg ">
           ...
           {token && <Link to={user.type === 'candidate' ? '/apply' : '/employer'} className={(location.pathname == '/apply' || location.pathname === '/employer') ? 'text-primary mx-5' : 'text-black mx-5 text-decoration-none' }>Profile</Link>}
